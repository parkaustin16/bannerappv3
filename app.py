...
@st.cache_data
def run_ocr(_reader, img_bytes, contrast_ths=0.05, adjust_contrast=0.7, text_threshold=0.7, decoder="beamsearch"):
...
if uploaded_file:
    ...
    # OCR Detection (cached run)
    ocr_reader = load_reader()  # cached instance
    ...
    # Run OCR (cached results)
    results = run_ocr(ocr_reader, img_bytes)
